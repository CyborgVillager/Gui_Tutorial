...
class Window(QDialog):
    ...
    def CreateLayout(self):
        ...
        self.radiobtn1.setIcon(QtGui.QIcon("image/python.png"))
        ...
        self.radiobtn2 = QRadioButton("Html")
        self.radiobtn2.setIcon(QtGui.QIcon("image/html5.png"))
        ...
        self.radiobtn3.setIcon(QtGui.QIcon("image/c_plus.png"))
